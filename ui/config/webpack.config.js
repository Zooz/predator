...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.EnvironmentPlugin(['NODE_ENV', 'PAYMENTS_OS_URL', 'ADMIN_TOOLS_URL', 'CONTROL_CENTER_URL', 'PERFORMANCE_FRAMEWORK_BUCKET_PATH','PERFORMANCE_FRAMEWORK_API_URL'])
  ]
};
