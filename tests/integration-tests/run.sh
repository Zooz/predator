...
echo Running integration tests with "$DATABASE_TYPE" db with db name: "$DATABASE_TYPE" and "$JOB_PLATFORM" integration
...
source $CURR_DIR/tests/configurations/"$DATABASE_NAME"Configuration.sh
