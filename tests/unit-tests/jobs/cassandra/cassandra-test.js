...
describe('Cassandra client tests', function() {
    ...
    describe('Insert new test tests', function(){
        it('should succeed simple insert', function(){
            ...
            let query = 'INSERT INTO jobs(id, test_id, arrival_rate, cron_expression, duration, emails, environment, ramp_to, webhooks, parallelism, max_virtual_users, notes, proxy_url, debug, enabled) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
        ...
        it('should log error for failing inserting new test', function(){
            ...
            return cassandraClient.insertJob(uuid.v4(), { test_id: uuid.v4(), arrival_rate: 1, duration: 1, cron_expression: '* * * *', emails: {}, environment: 'test', ramp_to: '1', webhooks: 1, notes: 'hello' })
                .catch(function(){
