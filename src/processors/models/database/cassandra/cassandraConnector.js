...
const INSERT_PROCESSOR = 'INSERT INTO processors(processor_id, name, description, type, file_url, javascript) values(?,?,?,?,?,?)';
...
function insertProcessor(processorId, processorInfo) {
    let params = [processorId, processorInfo.name, processorInfo.description, processorInfo.type, processorInfo.file_url, processorInfo.javascript];
