...
const Button = (props) => {
  ...
  return (
    <div onClick={isLoading ? undefined : onClick} className={classnames(style['button-wrapper'], { [style['button-without-menu']]: !menuActions, [style['disable']]: isLoading }, className)}>
